  ...
  <main id="content" role="main">
    ...
    <div class="container u-space-3-top">
      ...
      <div class="js-slick-carousel u-slick u-slick--gutters-2"
        ...
        <div class="js-slide rounded u-bg-img-hero min-height-450" style="background-image: url(https://nexusclinicassets.s3.ca-central-1.amazonaws.com/images/careers-jobs/lrg/staff-studio.jpg);"></div>
        <div class="js-slide rounded u-bg-img-hero min-height-450" style="background-image: url(https://nexusclinicassets.s3.ca-central-1.amazonaws.com/images/careers-jobs/lrg/staff-event.jpg);"></div>
        <div class="js-slide rounded u-bg-img-hero min-height-450" style="background-image: url(https://nexusclinicassets.s3.ca-central-1.amazonaws.com/images/careers-jobs/lrg/staff-rounds.jpg);"></div>
      </div>
      <!-- End Images Carousel -->
      ...
      <div class="w-lg-80 u-space-1-top mx-auto">
        <div class="u-space-1-bottom">
          <!-- Title -->
          <div class="mb-4">
            <h3 class="h5">Front Desk Duties:</h3>
          </div>
          <!-- End Title -->
          ...
          <ul class="list-unstyled mb-0">
            <li class="py-3">
              <div class="media">
                ...
                <div class="media-body text-secondary">
                  Greeting patients, answering phone calls, email, messages
                </div>
              </div>
            </li>
            <li class="py-3">
            ...
            <li class="py-3">
              <div class="media">
                ...
                <div class="media-body text-secondary">
                  Maintaining the growth of our clinic plants : )
                </div>
              </div>
            </li>
          </ul>
          <p>*The duties listed above are representative and not to be construed as all-inclusive.</p>
          <!-- End List -->
        </div>
        ...
        <div class="u-space-2-bottom">
          <!-- Title -->
          <div class="mb-4">
            <h3 class="h5">Required Knowledge, Skills and Abilities:</h3>
          </div>
          <!-- End Title -->
          ...
          <ul class="list-unstyled mb-0">
            <li class="py-3">
              <div class="media">
                ...
                <div class="media-body text-secondary">
                  Must have flexible hours and schedule (weekends, mornings and evening availabilities)
                </div>
              </div>
            </li>
            <li class="py-3">
  ...
  <script async type="application/ld+json">
    {
      ...
      "@type" : "JobPosting",
      "title" : "Receptionist",
      "description" : "<p>We're hiring! Looking for a part time receptionist to work at our top-rated multi-disciplinary clinic located at Yonge and Eglinton.</p>",
