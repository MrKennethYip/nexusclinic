  ...
  <main id="content" role="main">
    ...
    <div class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll"
      ...
      <div class="container position-relative u-space-5-top u-space-3-bottom z-index-2">
        <div class="w-lg-80 text-center mx-auto">
          <h1 class="display-3 font-size-48--md-down text-white font-weight-bold">TELEHEALTH</h1>
    ...
    <div style="background-color:#E7E8E8; border-top: 1px solid #898A8D">
      <div class="container u-space-1" style="background:url( https://s3.ca-central-1.amazonaws.com/nexusmassageclinic/logos/x-logo-white.svg) no-repeat; background-size:auto 100%;">
        ...
        <div class="container">
          <!-- Title -->
          <h2 class="text-dark font-weight-normal"><span class="font-weight-bold">What is Telehealth?<br></span></h2>
          <!-- End Title -->
        </div>
            ...
            <div class="row align-items-center">
              <div class="col-lg-7 mb-9 mb-lg-0">
                <div class="pr-lg-4 mb-7">
                  <p>Telehealth is the use of technology to provide real-time remote access to healthcare order. Nexus Massage & Rehab utilizes Phzio Telehealth platform to provide secure, private healthcare in the comfort of your home.</p>
                </div>
              </div>
    ...
    <div class="container u-space-2-top">
      <!-- Title -->
      <h2 class="text-dark font-weight-normal u-space-1-bottom text-center"><span class="font-weight-bold">What services are available on Telehealth?</span></h2>
      <!-- End Title -->
    </div>

    <!-- Service Item Start -->
    <div class="scrolltag" id="follow-up"></div>
     <div class="position-relative">
      <div class="container u-space-1-top">
        <div class="row align-items-center">
          ...
          <div class="col-lg-5 position-relative">
            <div id="video" class="u-video-player">
              <img class="img-fluid u-video-player__preview" style="border: #636569 1px solid;" src="https://nexusmassageclinic.s3.ca-central-1.amazonaws.com/images/service-pages/telehealth/med/virtual_follow-up.jpg" alt="Telehealth - Follow Up - Physio, Chiro, Osteo">
    ...
    <!-- Service Item Start -->
     <div class="scrolltag" id="consultation"></div>
     <div class="position-relative">
      <div class="container u-space-2-top u-space-3-bottom">
        <div class="row align-items-center">
          <div class="col-lg-7 mb-9 mb-lg-0">
            <div class="pr-lg-4 mb-7">
              <h2 class="text-primary"> 
    ...
    <div class="container u-space-2">
      <div class="w-md-80 w-lg-50 text-center mx-auto mb-7">
        <h3 class="text-primary font-weight-normal"><span class="font-weight-bold">Practitioners offering Virtual Telehealth Services</span></h3>
      </div>    
    ...
    <div style="background-color:#E7E8E8; border: 1px solid #898A8D">
      <div class="container" style="background:url( https://s3.ca-central-1.amazonaws.com/nexusmassageclinic/logos/x-logo-white.svg) no-repeat; background-size:auto 100%;">
        ...
        <div class="container u-space-2-top">
          <!-- Title -->
          <h2 class="text-dark font-weight-normal"><span class="font-weight-bold">How Does it Work?<br></span></h2>
          <!-- End Title -->
        </div>

         <div class="scrolltag" id="how_it_works"></div>
         <div class="position-relative">
          <div class="container u-space-1">
            <div class="row align-items-center">
              <div class="col-lg-7 mb-9 mb-lg-0">
                <div class="pr-lg-4 mb-7">
                  ...
                  <div class="text-black">
                    ...
                    &nbsp;All you need to get started is internet, computer / laptop or phone that has a working camera!</span>
            ...
            <div class="card-header px-4" id="FAQHeadingZero">
              <div class="collapsed" data-toggle="collapse" data-target="#FAQZero" aria-expanded="false" aria-controls="FAQZero" role="button">
                <h3 class="h5 d-flex justify-content-between align-items-center font-weight-normal u-card-collapse__heading mb-0">
                  What if my practitioner is not available for Virtual Sessions?
          ...
          <div class="card mb-3 u-card-collapse">
            <div class="card-header px-4" id="FAQHeadingTwo-alt">
              <div class="collapsed" data-toggle="collapse" data-target="#FAQTwo-alt" aria-expanded="false" aria-controls="FAQTwo-alt" role="button">
                <h3 class="h5 d-flex justify-content-between align-items-center font-weight-normal u-card-collapse__heading mb-0">
                  What do I need to start my Virtual Session?
                  <span class="fa fa-angle-up u-card-collapse__heading-icon"></span>
                </h3>
              </div>
            </div>
          ...
          <div class="card mb-3 u-card-collapse">
            <div class="card-header px-4" id="FAQHeadingThree-alt">
              <div class="collapsed" data-toggle="collapse" data-target="#FAQThree-alt" aria-expanded="false" aria-controls="FAQThree-alt" role="button">
                <h3 class="h5 d-flex justify-content-between align-items-center font-weight-normal u-card-collapse__heading mb-0">
                  Do I need to download a program to operate these Virtual Sessions?
                  <span class="fa fa-angle-up u-card-collapse__heading-icon"></span>
                </h3>
              </div>
            </div>
            <div id="FAQThree-alt" class="collapse" aria-labelledby="FAQHeadingThree-alt" data-parent="#FAQCollapse">
              <div class="card-body px-4">
                No, you don’t need to download anything to start these sessions. Just click the link that is emailed to you and you can get started right away!
              </div>
            </div>
          </div>
          <!-- End Card -->
