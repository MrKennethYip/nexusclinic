    ...
    <div id="logoAndNav" class="container">
      ...
      <nav class="js-mega-menu navbar navbar-expand-md u-header__navbar">
        ...
        <a class="navbar-brand u-header__navbar-brand u-header__navbar-brand-top-space" href="../" aria-label="Nexus Clinic Logo">
          <img src="https://nexusclinicassets.s3.ca-central-1.amazonaws.com/logos/logo.svg" alt="Nexus Massage & Rehab - Yonge & Eglinton - Logo - Chiropractor | Physio | Registered Massage Therapist" title="Nexus Massage & Rehab - Yonge & Eglinton - Chiropractor | Physio | Registered Massage Therapist" style="width: 200px;">
        </a>
        <!-- End Logo -->
        ...
        <div id="navBar" class="collapse navbar-collapse py-0">
          <ul class="navbar-nav u-header__navbar-nav ml-lg-auto">
            ...
            <!-- Home - Link -->
            <li class="nav-item">
              <a class="nav-link u-header__nav-link font-weight-bold" href="/">
                HOME
              </a>
            </li>
            <!-- End Home - Link -->
            ...
            <!-- About Us - Link -->
            <li class="nav-item">
              <a class="nav-link u-header__nav-link font-weight-bold" href="/about-us">
                ABOUT US
              </a>
            </li>
            <!-- End About Us - Link -->
            ...
            <!-- Services - Link -->
            <li class="nav-item">
              <a class="nav-link u-header__nav-link font-weight-bold" href="/services">
                SERVICES
              </a>
            </li>
            <!-- End Services - Link -->
            ...
            <li class="nav-item hs-has-sub-menu u-header__nav-item"
              ...
              <ul id="pagesSubMenu" class="list-inline hs-sub-menu u-header__sub-menu py-3 mb-0" style="min-width: 140px;"
                  aria-labelledby="pagesMegaMenu">
                <li class="dropdown-item">
                  <a class="nav-link u-header__sub-menu-nav-link u-list__link py-2" href="https://nexushealthclinic.com/community/learn/">
                    LEARN
                    <span class="fa fa-angle-right u-header__sub-menu-nav-link-icon"></span>
                  </a>
                </li>
                <li class="dropdown-item">
                  <a class="nav-link u-header__sub-menu-nav-link u-list__link py-2" href="https://nexushealthclinic.com/community/events/">
                    EVENTS
                    <span class="fa fa-angle-right u-header__sub-menu-nav-link-icon"></span>
                  </a>
                </li>
