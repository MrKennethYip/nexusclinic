...
<head>
  <!-- Title -->
  <title>Riccyn Reyes (RMT) | Nexus Massage & Rehab | (647) 557-6267</title>

  <meta name="Description" content="Learn about the team at Nexus Massage & Rehab. Riccyn Reyes specializes in massage therapy & lower back pain at our Yonge & Eglinton clinic. Learn more!">
  <meta name="keywords" content="Riccyn Reyes, Best RMT, deep tissue, back pain, neck pain, massage at yonge and eglinton, best massage therapist, muscle aches, sore muscles, muscle spasm, proper posture, ergonomic assessment, strong massage therapist, deep pressure, professional massage therapist, massage for back pain, massage to decrease neck pain, massage to help back pain, best massage therapist, back problems, back relief, upper back pain, what helps with back pain, sore back, chronic neck pain, back pain relief, lower back pain relief, lumbar spine, back strain, neck problems, sore neck, backache, back strain, neck and shoulder tension">
  ...
  <main id="content" role="main">
    ...
    <div class="position-relative text-center custom-top-spacing u-gradient-overlay-half-info-v1 u-bg-img-hero">
      <div class="row justify-content-md-center">
        ...
        <div class="col-md-8 col-lg-7 col-xl-5">
          ...
          <!-- Info -->
          <div class="mb-4">
            <h1 class="display-4 font-size-48--md-down text-white font-weight-bold">RICCYN REYES</h1>
          </div>

          <ul class="list-inline">
            <li class="list-inline-item">
              <a class="u-text-light" href="mailto:riccyn@nexushealthclinic.com">
                <span class="far fa-envelope mr-2"></span>
                riccyn@nexushealthclinic.com
              </a>
            </li>
          </ul>
          <!-- End Info -->
          ...
          <!-- Avatar -->
          <img class="img-fluid u-xl-avatar u-xl-avatar--bordered u-avatar-v1 rounded-circle mx-auto" src="https://s3.ca-central-1.amazonaws.com/nexusmassageclinic/images/profile/med/riccyn_reyes.jpg" alt="Riccyn Reyes - Profile">
          <!-- End Avatar -->
          </div>
        </div>
      ...
      <div class="container u-space-2">
        <div class="row">
            ...
            <div class="card p-1 mb-4" style="min-width: 225px;">
              <div class="card-body text-center">
                <div class="mb-2">
                  ...
                  <a class="btn btn-block u-btn-primary--air transition-3d-hover" href="mailto:riccyn@nexushealthclinic.com">
                    <span class="far fa-envelope mr-2"></span>
                    Send a Message
                  </a>
                </div>
              ...
              <div class="card-body">
                ...
                <span class="d-flex align-items-start">
                  ...
                  <div class="ml-2">
                    ...
                    <p class="text-dark"><strong>Tues:</strong><span class="ml-3"></span>11am - 8pm</p>
                    <p class="text-dark"><strong>Wed:</strong><span class="ml-3"></span>11am - 8pm</p>
          ...
          <div class="col-lg-9">
              ...
              <!-- Text -->
              <p>I graduated Registered Massage Therapist (RMT) program with honours and in good standing with the College of Massage Therapists of Ontario (CMTO). I am also a member of the Registered Massage Therapist of Ontario (RMTAO).</p>

              <p>I am very passionate with what I do as an RMT. I always try my best to find a way to improve myself so in return, I am able to help my clients better.</p>
              
              <p>In my free time, I enjoy spending time with my son. I also have fun dancing salsa and bachata.</p>
              ...
              <!-- Text -->
              <p>Trigger point therapy, Deep tissue Massage and Pressure point technique.</p>
              
              <p>Rest assured that the treatment will be tailored to each client's purpose - whether it is therapeutic or purely relaxation. </p>
              <!-- End Text -->
              ...
              <!-- Text -->
              <p>Every time I am able to contribute to my client's optimal health.</p>
              <!-- End Text -->
              ...
              <!-- Text -->
              <p>I will make sure that I listen to my client's concern every single time that they come to see me. I value collaboration a lot and I know that in order for the client to achieve the best results, both sides need to work together. As a therapist, I am very determined to help my clients in every way I can. </p>
              <!-- End Text -->
    ...
    <div class="u-bg-light-blue-50 u-space-2-bottom">
      <div class="container">
        ...
        <div class='embedsocial-reviews' data-ref="446e69ee01c879d5ec10f844c985fa93ce03aa85"></div><script>(function(d, s, id){var js; if (d.getElementById(id)) {return;} js = d.createElement(s); js.id = id; js.src = "https://embedsocial.com/embedscript/ri.js"; d.getElementsByTagName("head")[0].appendChild(js);}(document, "script", "EmbedSocialReviewsScript"));</script>
