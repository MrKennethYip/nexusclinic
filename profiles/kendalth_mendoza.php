...
<head>
  <!-- Title -->
  <title>Kendalth Mendoza (RMT) | Nexus Massage & Rehab | (647) 557-6267</title>

  <meta name="Description" content="Learn about the team at Nexus Massage & Rehab. Kendalth Mendoza specializes in massage therapy & lower back pain at our Yonge & Eglinton clinic. Learn more!">
  <meta name="keywords" content="Kendalth Mendoza, Best RMT, deep tissue, back pain, neck pain, massage at yonge and eglinton, best massage therapist, muscle aches, sore muscles, muscle spasm, proper posture, ergonomic assessment, strong massage therapist, deep pressure, professional massage therapist, massage for back pain, massage to decrease neck pain, massage to help back pain, best massage therapist, back problems, back relief, upper back pain, what helps with back pain, sore back, chronic neck pain, back pain relief, lower back pain relief, lumbar spine, back strain, neck problems, sore neck, backache, back strain, neck and shoulder tension">
...
<body>
  ...
  <main id="content" role="main">
    ...
    <div class="position-relative text-center custom-top-spacing u-gradient-overlay-half-info-v1 u-bg-img-hero">
      <div class="row justify-content-md-center">
        ...
        <div class="col-md-8 col-lg-7 col-xl-5">
          ...
          <!-- Info -->
          <div class="mb-4">
            <h1 class="display-4 font-size-48--md-down text-white font-weight-bold">KENDALTH MENDOZA</h1>
          </div>

          <ul class="list-inline">
            <li class="list-inline-item">
              <a class="u-text-light" href="mailto:kendalth@nexushealthclinic.com">
                <span class="far fa-envelope mr-2"></span>
                kendalth@nexushealthclinic.com
              </a>
            </li>
          </ul>
          <!-- End Info -->
          ...
          <!-- Avatar -->
          <img class="img-fluid u-xl-avatar u-xl-avatar--bordered u-avatar-v1 rounded-circle mx-auto" src="https://s3.ca-central-1.amazonaws.com/nexusmassageclinic/images/profile/med/kendalth_mendoza.jpg" alt="Kendalth Mendoza - Profile">
          <!-- End Avatar -->
          </div>
        </div>
      ...
      <div class="container u-space-2">
        <div class="row">
            ...
            <div class="card p-1 mb-4" style="min-width: 225px;">
              <div class="card-body text-center">
                <div class="mb-2">
                  ...
                  <a class="btn btn-block u-btn-primary--air transition-3d-hover" href="mailto:kendalth@nexushealthclinic.com">
                    <span class="far fa-envelope mr-2"></span>
                    Send a Message
                  </a>
                </div>
          ...
          <div class="col-lg-9">
              ...
              <!-- Text -->
              <p>Massage Therapy reflects who I am. I'm into helping people, running, weight lifting, and badminton. I feel that massage therapy lets me meet all kind of people and allows me to have a meaningful job, enriching people's lives. This job also allows me to develop a better appreciation for physical health.</p>
              ...
              <!-- Text -->
              <p>I enjoy all kinds of cases, from relaxation massage to stiff head, neck, and shoulders, to sport performance, or lack of range of motion.</p>
              <!-- End Text -->
              ...
              <!-- Text -->
              <p>Top 3 treatments: relaxation, decrease tension in the neck and shoulders, and low back pain.</p>
              <!-- End Text -->
              ...
              <!-- Text -->
              <p>I am proud of being able to have a long term patient to therapist relationship. Seeing my patients on a continual basis and hearing improvements from them is a great joy and gives me drive to continue as a massage therapist.</p>
              <!-- End Text -->
              ...
              <!-- Text -->
              <p>I am easy to get along with and I am able to bring good results. I do this by listening carefully to what the patient wants and describes, and I use years of experience to allow me to help the patient. I give good pressure.</p>
              <!-- End Text -->
    ...
    <div class="u-bg-light-blue-50 u-space-2-bottom">
      <div class="container">
        <!-- Review Widget -->
        <div class="embedsocial-reviews" data-ref="1449dd917ba6c1dea8eebf251858d45a263d225c"></div> <script> (function(d, s, id){ var js; if (d.getElementById(id)) {return;} js = d.createElement(s); js.id = id; js.src = "https://embedsocial.com/embedscript/ri.js"; d.getElementsByTagName("head")[0].appendChild(js); }(document, "script", "EmbedSocialReviewsScript")); </script>
        <!-- End Review Widget -->
      </div>
    </div>
