...
<body>
  ...
  <main id="content" role="main">
    ...
    <div class="position-relative text-center custom-top-spacing u-gradient-overlay-half-info-v1 u-bg-img-hero">
      <div class="row justify-content-md-center">
        ...
        <div class="col-md-8 col-lg-7 col-xl-5">
          ...
          <!-- Avatar -->
          <img class="img-fluid u-xl-avatar u-xl-avatar--bordered u-avatar-v1 rounded-circle mx-auto" src="https://nexusclinicassets.s3.ca-central-1.amazonaws.com/images/profile/med/ellen_zhang.jpg" alt="Ellen Zhang - Registered Massage Therapist">
          <!-- End Avatar -->
          </div>
        </div>
            ...
            <div class="card p-1 mb-4" style="min-width: 225px;">
              <div class="card-body text-center">
                <div class="mb-2">
                  ...
                  <a class="btn btn-block u-btn-primary--air transition-3d-hover" href="mailto:ellen@nexushealthclinic.com">
                    <span class="far fa-envelope mr-2"></span>
                    Send a Message
                  </a>
                </div>
              ...
              <div class="card-body">
                ...
                <span class="d-flex align-items-start">
                  ...
                  <div class="ml-2">
                    ...
                    <p class="text-dark"><strong>Tues:</strong><span class="ml-3"></span>1pm - 7pm</p>
                    <p class="text-dark"><strong>Fri:</strong><span class="ml-3"></span>12pm - 7pm</p>
    ...
    <div class="u-bg-light-blue-50 u-space-2-bottom">
      <div class="container">
        <!-- Review Widget -->
        <div class='embedsocial-reviews' data-ref="4fe9db7bb79fd3bc3a667ed9aaab4785ec61bc82"></div>
