...
<head>
  <!-- Title -->
  <title>Rob Hunter (RMT) | Nexus Massage & Rehab | (647) 557-6267</title>

  <meta name="Description" content="Learn about the team at Nexus Massage & Rehab. Rob Hunter specializes in massage therapy & lower back pain at our Yonge & Eglinton clinic. Learn more!">
  <meta name="keywords" content="Rob Hunter, Best RMT, deep tissue, back pain, neck pain, massage at yonge and eglinton, best massage therapist, muscle aches, sore muscles, muscle spasm, proper posture, ergonomic assessment, strong massage therapist, deep pressure, professional massage therapist, massage for back pain, massage to decrease neck pain, massage to help back pain, best massage therapist, back problems, back relief, upper back pain, what helps with back pain, sore back, chronic neck pain, back pain relief, lower back pain relief, lumbar spine, back strain, neck problems, sore neck, backache, back strain, neck and shoulder tension">
  ...
  <main id="content" role="main">
    ...
    <div class="position-relative text-center custom-top-spacing u-gradient-overlay-half-info-v1 u-bg-img-hero">
      <div class="row justify-content-md-center">
        ...
        <div class="col-md-8 col-lg-7 col-xl-5">
          ...
          <!-- Info -->
          <div class="mb-4">
            <h1 class="display-4 font-size-48--md-down text-white font-weight-bold">ROB HUNTER</h1>
          </div>

          <ul class="list-inline">
            <li class="list-inline-item">
              <a class="u-text-light" href="mailto:Rob@nexushealthclinic.com">
                <span class="far fa-envelope mr-2"></span>
                Rob@nexushealthclinic.com
              </a>
            </li>
          </ul>
          <!-- End Info -->
          ...
          <!-- Avatar -->
          <img class="img-fluid u-xl-avatar u-xl-avatar--bordered u-avatar-v1 rounded-circle mx-auto" src="https://s3.ca-central-1.amazonaws.com/nexusmassageclinic/images/profile/med/rob_hunter.jpg" alt="Rob Hunter - Profile">
          <!-- End Avatar -->
          </div>
        </div>
      ...
      <div class="container u-space-2">
        <div class="row">
            ...
            <div class="card p-1 mb-4" style="min-width: 225px;">
              <div class="card-body text-center">
                <div class="mb-2">
                  ...
                  <a class="btn btn-block u-btn-primary--air transition-3d-hover" href="mailto:Rob@nexushealthclinic.com">
                    <span class="far fa-envelope mr-2"></span>
                    Send a Message
                  </a>
                </div>
              ...
              <div class="card-body">
                ...
                <span class="d-flex align-items-start">
                  ...
                  <div class="ml-2">
                    ...
                    <p class="text-dark"><strong>Sun:</strong><span class="ml-3"></span>9am - 5pm</p>
                  </div>
                </span>
                <!-- End User -->
          ...
          <div class="col-lg-9">
              ...
              <!-- Text -->
              <p>Before getting into massage therapy I was a competitive athlete playing hockey and lacrosse growing up. After my playing days I got into weight lifting and became a personal trainer. I'm passionate about helping people move pain free and improve their performance in sports or daily life.</p>
              <!-- End Text -->
              ...
              <!-- Text -->
              <p>I like helping people get out of pain and also helping people improve their quality of movement. It's great to see people improve during their massage sessions and get back to their life activities. I also like working with athletic populations to help keep their bodies working and performing at their best.</p>
              <!-- End Text -->
              ...
              <!-- Text -->
              <p>Sports massage, trigger points, deep tissue.</p>
              <!-- End Text -->
              ...
              <!-- Text -->
              <p>I am most proud of creating a welcoming atmosphere in my treatment room and helping people get through injuries.</p>
              <!-- End Text -->
              ...
              <!-- Text -->
              <p>I'll make sure to provide professional service during the treatment and provide any necessary self-care work to get you back to moving your best. I'll make sure your goal for the treatment is met and you leave the clinic feeling better than when you entered!</p>
              <!-- End Text -->
    ...
    <div class="u-bg-light-blue-50 u-space-2-bottom">
      <div class="container">
        ...
        <div class="embedsocial-reviews" data-ref="af5ea399eb3f30d7ed4137c84a2492b9f29e9bc1"></div> <script> (function(d, s, id){ var js; if (d.getElementById(id)) {return;} js = d.createElement(s); js.id = id; js.src = "https://embedsocial.com/embedscript/ri.js"; d.getElementsByTagName("head")[0].appendChild(js); }(document, "script", "EmbedSocialReviewsScript")); </script>
