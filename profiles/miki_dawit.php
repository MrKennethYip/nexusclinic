...
<head>
  <!-- Title -->
  <title>Miki Dawit (RMT) | Nexus Massage & Rehab | (647) 557-6267</title>

  <meta name="Description" content="Learn about the team at Nexus Massage & Rehab. Miki Dawit specializes in massage therapy & lower back pain at our Yonge & Eglinton clinic. Learn more!">
  <meta name="keywords" content="Miki Dawit, Best RMT, deep tissue, back pain, neck pain, massage at yonge and eglinton, best massage therapist, muscle aches, sore muscles, muscle spasm, proper posture, ergonomic assessment, strong massage therapist, deep pressure, professional massage therapist, massage for back pain, massage to decrease neck pain, massage to help back pain, best massage therapist, back problems, back relief, upper back pain, what helps with back pain, sore back, chronic neck pain, back pain relief, lower back pain relief, lumbar spine, back strain, neck problems, sore neck, backache, back strain, neck and shoulder tension">
...
<body>
  ...
  <main id="content" role="main">
    ...
    <div class="position-relative text-center custom-top-spacing u-gradient-overlay-half-info-v1 u-bg-img-hero">
      <div class="row justify-content-md-center">
        ...
        <div class="col-md-8 col-lg-7 col-xl-5">
          ...
          <!-- Info -->
          <div class="mb-4">
            <h1 class="display-4 font-size-48--md-down text-white font-weight-bold">MIKI DAWIT</h1>
          </div>

          <ul class="list-inline">
            <li class="list-inline-item">
              <a class="u-text-light" href="mailto:Miki@nexushealthclinic.com">
                <span class="far fa-envelope mr-2"></span>
                Miki@nexushealthclinic.com
              </a>
            </li>
          </ul>
          <!-- End Info -->
          ...
          <!-- Avatar -->
          <img class="img-fluid u-xl-avatar u-xl-avatar--bordered u-avatar-v1 rounded-circle mx-auto" src="https://s3.ca-central-1.amazonaws.com/nexusmassageclinic/images/profile/med/miki_dawit.jpg" alt="Miki Dawit - Profile">
          <!-- End Avatar -->
          </div>
        </div>
      ...
      <div class="container u-space-2">
        <div class="row">
            ...
            <div class="card p-1 mb-4" style="min-width: 225px;">
              <div class="card-body text-center">
                <div class="mb-2">
                  ...
                  <a class="btn btn-block u-btn-primary--air transition-3d-hover" href="mailto:Miki@nexushealthclinic.com">
                    <span class="far fa-envelope mr-2"></span>
                    Send a Message
                  </a>
                </div>
          ...
          <div class="col-lg-9">
              ...
              <!-- Text -->
              <p>I am a Registered Massage Therapist who graduated from Royal Canadian College of Massage Therapy. I also have a degree in Kinesiology and Recreation from the University of Winnipeg with a background in personal training and fitness. As a competitive athlete for many years, I understands that massage therapy is an integral part of injury prevention, rehabilitation, and overall health.</p>
              
              <p>In my spare time I like to weight train, watch movies and travel. When I'm at home I like to spend time with my dog, Gohan.</p>
              <!-- End Text -->
              ...
              <!-- Text -->
              <p>I enjoy treating the back, neck, shoulders and educating clients on how they can improve posture and proper workplace ergonomics. I also enjoy working with athletes and helping with reducing or preventing injury.</p>
              <!-- End Text -->
              ...
              <!-- Text -->
              <p>The treatments that i specialize in are deep tissue, trigger point therapy, and relaxation.</p>
              <!-- End Text -->
              ...
              <!-- Text -->
              <p>I am proud that I can help my clients get back to better health and wellness and achieve physical contentment. I'm passionate about giving the best care possible to each client. As I work as an RMT, I intend to take courses to be able to provide more services and benefits to my clients.</p>
              <!-- End Text -->
              ...
              <!-- Text -->
              <p>I like to work with patients to create the most effective treatment tailored to their needs making each session suited just for that client. Whether you want to  improve range of motion, alleviate pain, or just simply unwind.</p>
              <!-- End Text -->
    ...
    <div class="u-bg-light-blue-50 u-space-2-bottom">
      <div class="container">
        <!-- Review Widget -->
        <div class="embedsocial-reviews" data-ref="89d0b98f21bcb19d4e9d07a306f3c7cec0127a39"></div> <script> (function(d, s, id){ var js; if (d.getElementById(id)) {return;} js = d.createElement(s); js.id = id; js.src = "https://embedsocial.com/embedscript/ri.js"; d.getElementsByTagName("head")[0].appendChild(js); }(document, "script", "EmbedSocialReviewsScript")); </script>
        <!-- End Review Widget -->
      </div>
    </div>
