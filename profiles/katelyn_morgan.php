...
<body>
  ...
  <main id="content" role="main">
    ...
    <div class="position-relative text-center custom-top-spacing u-gradient-overlay-half-info-v1 u-bg-img-hero">
      <div class="row justify-content-md-center">
        ...
        <div class="col-md-8 col-lg-7 col-xl-5">
          ...
          <!-- Info -->
          <div class="mb-4">
            <h1 class="display-4 font-size-48--md-down text-white font-weight-bold">KATELYN MORGAN</h1>
          </div>

          <ul class="list-inline">
            <li class="list-inline-item">
              <a class="u-text-light" href="mailto:katelyn@nexushealthclinic.com">
                <span class="far fa-envelope mr-2"></span>
                katelyn@nexushealthclinic.com
              </a>
            </li>
          </ul>
          <!-- End Info -->
          ...
          <!-- Avatar -->
          <img class="img-fluid u-xl-avatar u-xl-avatar--bordered u-avatar-v1 rounded-circle mx-auto" src="https://s3.ca-central-1.amazonaws.com/nexusmassageclinic/images/profile/med/katelyn_morgan.jpg" alt="Katelyn Morgan - Profile">
          <!-- End Avatar -->
          </div>
        </div>
      ...
      <div class="container u-space-2">
        <div class="row">
            ...
            <div class="card p-1 mb-4" style="min-width: 225px;">
              <div class="card-body text-center">
                <div class="mb-2">
                  ...
                  <a class="btn btn-block u-btn-primary--air transition-3d-hover" href="mailto:katelyn@nexushealthclinic.com">
                    <span class="far fa-envelope mr-2"></span>
                    Send a Message
                  </a>
                </div>
              ...
              <div class="card-body">
                ...
                <span class="d-flex align-items-start">
                  ...
                  <div class="ml-2">
                    ...
                    <p class="text-dark"><strong>Tues:</strong><span class="ml-3"></span>1pm - 5:30pm</p>
                    <p class="text-dark"><strong>Thurs:</strong><span class="ml-3"></span>1pm - 8pm</p>
          ...
          <div class="col-lg-9">
              ...
              <!-- Text -->
              <p>I moved to Toronto to pursue post secondary education, and have a background in Law and Security, Fitness and Health, and Massage Therapy. I decided I wanted something more to go along with my background in Fitness, and as a Varsity athlete, I experienced my fair share of injuries. Massage Therapy helped me so much that I wanted to give others the same great care that I received. Outside of work, I am a runner, preferring long distance running in trails or out on the road.</p>
              <!-- End Text -->
              ...
              <!-- Text -->
              <p>I love to treat any kind of case from treating the general population, individuals with physical or mental disabilities, and palliative care cases. What ever kind of case I am given, I enjoy providing treatment.</p>
              <!-- End Text -->
              ...
              <!-- Text -->
              <p>I specialize in Myofascial release, deep tissue, and exercise prescription.</p>
              <!-- End Text -->
              ...
              <!-- Text -->
              <p>I am most proud of knowing that I am making a difference in other people's lives, whether big or small. I strive to help others live their lives comfortable and to their highest potential physically.</p>
              <!-- End Text -->
              ...
              <!-- Text -->
              <p>When treating, I listen to my patients and their goals, and also educate them on what I feel would benefit them. I provide a trusting and comfortable environment so my patients will feel at ease.</p>
              <!-- End Text -->
    ...
    <div class="u-bg-light-blue-50 u-space-2-bottom">
      <div class="container">
        <!-- Review Widget -->
        <div class='embedsocial-reviews' data-ref="2c77ae3e50672a89d08aa80bfb7ae9b7de0134bd"></div><script>(function(d, s, id){var js; if (d.getElementById(id)) {return;} js = d.createElement(s); js.id = id; js.src = "https://embedsocial.com/embedscript/ri.js"; d.getElementsByTagName("head")[0].appendChild(js);}(document, "script", "EmbedSocialReviewsScript"));</script>
        <!-- End Review Widget -->
      </div>
    </div>
