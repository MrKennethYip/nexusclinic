...
<head>
  <!-- Title -->
  <title>Mozhgan Roshan Ravan (RMT) | Nexus Massage & Rehab | (647) 557-6267</title>

  <meta name="Description" content="Learn about the team at Nexus Massage & Rehab. Mozhgan Roshan Ravan specializes in massage therapy & lower back pain at our Yonge & Eglinton clinic. Learn more!">
  <meta name="keywords" content="Mozhgan Roshan Ravan, Best RMT, deep tissue, back pain, neck pain, massage at yonge and eglinton, best massage therapist, muscle aches, sore muscles, muscle spasm, proper posture, ergonomic assessment, strong massage therapist, deep pressure, professional massage therapist, massage for back pain, massage to decrease neck pain, massage to help back pain, best massage therapist, back problems, back relief, upper back pain, what helps with back pain, sore back, chronic neck pain, back pain relief, lower back pain relief, lumbar spine, back strain, neck problems, sore neck, backache, back strain, neck and shoulder tension">
  ...
  <main id="content" role="main">
    ...
    <div class="position-relative text-center custom-top-spacing u-gradient-overlay-half-info-v1 u-bg-img-hero">
      <div class="row justify-content-md-center">
        ...
        <div class="col-md-8 col-lg-7 col-xl-5">
          ...
          <!-- Info -->
          <div class="mb-4">
            <h1 class="display-4 font-size-48--md-down text-white font-weight-bold">MOZHGAN ROSHAN RAVAN</h1>
          </div>

          <ul class="list-inline">
            <li class="list-inline-item">
              <a class="u-text-light" href="mailto:Mozhgan@nexushealthclinic.com">
                <span class="far fa-envelope mr-2"></span>
                Mozhgan@nexushealthclinic.com
              </a>
            </li>
          </ul>
          <!-- End Info -->
      ...
      <div class="container u-space-2">
        <div class="row">
            ...
            <div class="card p-1 mb-4" style="min-width: 225px;">
              <div class="card-body text-center">
                <div class="mb-2">
                  ...
                  <a class="btn btn-block u-btn-primary--air transition-3d-hover" href="mailto:Mozhgan@nexushealthclinic.com">
                    <span class="far fa-envelope mr-2"></span>
                    Send a Message
                  </a>
                </div>
              ...
              <div class="card-body">
                ...
                <span class="d-flex align-items-start">
                  ...
                  <div class="ml-2">
                    ...
                    <p class="text-dark"><strong>Fri:</strong><span class="ml-3"></span>5pm - 9pm</p>
          ...
          <div class="col-lg-9">
              ...
              <!-- Text -->
              <p>I enjoying working out, doing power yoga to keep myself healthy and strong. On my free time, I enjoy taking courses to advance my skills as an RMT, as well as learning new languages. I am well versed in Farsi, English and taking French as a hobby.</p>
              <!-- End Text -->
              ...
              <!-- Text -->
              <p>I enjoy treating people with stress tension in their body. Stress can affect both the mind and body, as a massage therapist, I like to treat these tension areas to help relieve stress in the muscles and bring my patients in a better mood when they leave our sessions.</p>
              <!-- End Text -->
              ...
              <!-- Text -->
              <p>Trigger point therapy - to decrease knots in muscles. Myofascial release - to stretch out fascia and increase length, circulation and fluid in muscles. Deep tissue therapy - to address all those deep tight muscles.</p>
              <!-- End Text -->
              ...
              <!-- Text -->
              <p>I am most proud of being able to read people psychologically and physically in our treatment sessions and tailor our treatments to address their concerns. I have worked with different segments of people, such as the elderly, disabled and the young and have a fine touch to understand what their body needs are to bring them to recovery.</p>
              <!-- End Text -->
              ...
              <!-- Text -->
              <p>I am very sensitive to people's needs and will always adjust the treatments to best suit my patients. I welcome all feedback and have an open communication with my patients to ensure the treatment is right for them at all times.</p>
              <!-- End Text -->
    ...
    <div class="u-bg-light-blue-50 u-space-2-bottom">
      <div class="container">
        ...
        <div class='embedsocial-reviews' data-ref="05b7b7d25757e725c23e5498621fbcf92979fd8f"></div><script>(function(d, s, id){var js; if (d.getElementById(id)) {return;} js = d.createElement(s); js.id = id; js.src = "https://embedsocial.com/embedscript/ri.js"; d.getElementsByTagName("head")[0].appendChild(js);}(document, "script", "EmbedSocialReviewsScript"));</script>
