...
<head>
  <!-- Title -->
  <title>Sharlene Castro (RMT) | Nexus Massage & Rehab | (647) 557-6267</title>

  <meta name="Description" content="Learn about the team at Nexus Massage & Rehab. Sharlene Castro specializes in massage therapy & lower back pain at our Yonge & Eglinton clinic. Learn more!">
  <meta name="keywords" content="Sharlene Castro, Best RMT, deep tissue, back pain, neck pain, massage at yonge and eglinton, best massage therapist, muscle aches, sore muscles, muscle spasm, proper posture, ergonomic assessment, strong massage therapist, deep pressure, professional massage therapist, massage for back pain, massage to decrease neck pain, massage to help back pain, best massage therapist, back problems, back relief, upper back pain, what helps with back pain, sore back, chronic neck pain, back pain relief, lower back pain relief, lumbar spine, back strain, neck problems, sore neck, backache, back strain, neck and shoulder tension">
  ...
  <main id="content" role="main">
    ...
    <div class="position-relative text-center custom-top-spacing u-gradient-overlay-half-info-v1 u-bg-img-hero">
      <div class="row justify-content-md-center">
        ...
        <div class="col-md-8 col-lg-7 col-xl-5">
          ...
          <!-- Info -->
          <div class="mb-4">
            <h1 class="display-4 font-size-48--md-down text-white font-weight-bold">SHARLENE CASTRO</h1>
          </div>

          <ul class="list-inline">
            <li class="list-inline-item">
              <a class="u-text-light" href="mailto:sharlene@nexushealthclinic.com">
                <span class="far fa-envelope mr-2"></span>
                sharlene@nexushealthclinic.com
              </a>
            </li>
          </ul>
          <!-- End Info -->
          ...
          <!-- Avatar -->
          <img class="img-fluid u-xl-avatar u-xl-avatar--bordered u-avatar-v1 rounded-circle mx-auto" src="https://s3.ca-central-1.amazonaws.com/nexusmassageclinic/images/profile/med/sharlene_castro.jpg" alt="Sharlene Castro - Profile">
          <!-- End Avatar -->
          </div>
        </div>
      ...
      <div class="container u-space-2">
        <div class="row">
            ...
            <div class="card p-1 mb-4" style="min-width: 225px;">
              <div class="card-body text-center">
                <div class="mb-2">
                  ...
                  <a class="btn btn-block u-btn-primary--air transition-3d-hover" href="mailto:sharlene@nexushealthclinic.com">
                    <span class="far fa-envelope mr-2"></span>
                    Send a Message
                  </a>
                </div>
            ...
            <div class="card p-1 mb-4" style="min-width: 225px;">
              <div class="card-body">
                ...
                <span class="d-flex align-items-start">
                  ...
                  <div class="ml-2">
                    <p class="text-dark"><strong>Thurs:</strong><span class="ml-3"></span>2pm - 8pm</p>
                    <p class="text-dark"><strong>Fri:</strong><span class="ml-3"></span>2pm - 8pm</p>
          ...
          <div class="col-lg-9">
              ...
              <!-- Text -->
              <p>Before becoming a Registered Massage Therapist, I received my Bachelor of Health Science degree in Kinesiology (with a specialization in Exercise Science) from the University of Ontario Institute of Technology. My university experience provided me with the opportunity to work closely with athletes and from there, I was introduced to sports medicine and the world of rehabilitation.</p>

              <p>In addition, my personal experience with injuries sustained during competitive sports and physical activity sparked my interest in understanding sport-related injuries and kinesthetics. And, ultimately, my passion for health promotion and massage. After obtaining my undergraduate degree, I completed my education in massage therapy at the Canadian College of Massage and Hydrotherapy (CCMH) and graduated with honours.</p>
              
              <p>In my free time, you can catch me on a badminton or tennis court, running a 5K on a track or trail, going on hikes or weightlifting. I’ve also got quite the palate; I love being introduced to new types of cuisines and trying my hand at emulating certain recipes.</p>
              ...
              <!-- Text -->
              <p>I like to incorporate myofascial release techniques as well as trigger point release therapy into all of my treatments. Essentially, both techniques assist in reducing pain and improving posture. </p>
              
              <p>In addition, I ensure that I am providing my patients with remedial home care, such as hydrotherapy modalities and/ or exercises to enhance the effects of massage therapy. I believe patient education plays a significant role in achieving short-term and long-term health goals. </p>
              <!-- End Text -->
              ...
              <!-- Text -->
              <p>As a massage therapist, the greatest form of satisfaction is seeing a patient feel a sense of relief, even after just one treatment, in addition to, being able to be a part of that milestone on their journey to reaching their goals.</p>
              <!-- End Text -->
    ...
    <div class="u-bg-light-blue-50 u-space-2-bottom">
      <div class="container">
        ...
        <div class='embedsocial-reviews' data-ref="5b1a6287d683aee2e54145b51a914ec81a6f260e"></div><script>(function(d, s, id){var js; if (d.getElementById(id)) {return;} js = d.createElement(s); js.id = id; js.src = "https://embedsocial.com/embedscript/ri.js"; d.getElementsByTagName("head")[0].appendChild(js);}(document, "script", "EmbedSocialReviewsScript"));</script>
