...
<head>
  <!-- Title -->
  <title>Thomas Murphy (RMT) | Nexus Massage & Rehab | (647) 557-6267</title>

  <meta name="Description" content="Learn about the team at Nexus Massage & Rehab. Thomas Murphy specializes in massage therapy & lower back pain at our Yonge & Eglinton clinic. Learn more!">
  <meta name="keywords" content="Thomas Murphy, Best RMT, deep tissue, back pain, neck pain, massage at yonge and eglinton, best massage therapist, muscle aches, sore muscles, muscle spasm, proper posture, ergonomic assessment, strong massage therapist, deep pressure, professional massage therapist, massage for back pain, massage to decrease neck pain, massage to help back pain, best massage therapist, back problems, back relief, upper back pain, what helps with back pain, sore back, chronic neck pain, back pain relief, lower back pain relief, lumbar spine, back strain, neck problems, sore neck, backache, back strain, neck and shoulder tension">
  ...
  <main id="content" role="main">
    ...
    <div class="position-relative text-center custom-top-spacing u-gradient-overlay-half-info-v1 u-bg-img-hero">
      <div class="row justify-content-md-center">
        ...
        <div class="col-md-8 col-lg-7 col-xl-5">
          ...
          <!-- Info -->
          <div class="mb-4">
            <h1 class="display-4 font-size-48--md-down text-white font-weight-bold">THOMAS MURPHY</h1>
          </div>

          <ul class="list-inline">
            <li class="list-inline-item">
              <a class="u-text-light" href="mailto:thomas@nexushealthclinic.com">
                <span class="far fa-envelope mr-2"></span>
                thomas@nexushealthclinic.com
              </a>
            </li>
          </ul>
          <!-- End Info -->
          ...
          <!-- Avatar -->
          <img class="img-fluid u-xl-avatar u-xl-avatar--bordered u-avatar-v1 rounded-circle mx-auto" src="https://s3.ca-central-1.amazonaws.com/nexusmassageclinic/images/profile/med/thomas_murphy.jpg" alt="Thomas Murphy - Profile">
          <!-- End Avatar -->
          </div>
        </div>
      ...
      <div class="container u-space-2">
        <div class="row">
            ...
            <div class="card p-1 mb-4" style="min-width: 225px;">
              <div class="card-body text-center">
                <div class="mb-2">
                  ...
                  <a class="btn btn-block u-btn-primary--air transition-3d-hover" href="mailto:thomas@nexushealthclinic.com">
                    <span class="far fa-envelope mr-2"></span>
                    Send a Message
                  </a>
                </div>
            ...
            <div class="card p-1 mb-4" style="min-width: 225px;">
              <div class="card-body">
                ...
                <span class="d-flex align-items-start">
                  ...
                  <div class="ml-2">
                    <p class="text-dark"><strong>Mon:</strong><span class="ml-3"></span>8am - 12:30pm</p>
                    <p class="text-dark"><strong>Sat:</strong><span class="ml-3"></span>12pm - 7pm</p>
                    <p class="text-dark"><strong>Sun:</strong><span class="ml-3"></span>12pm - 7pm</p>
                  </div>
                </span>
                <!-- End User -->
          ...
          <div class="col-lg-9">
              ...
              <!-- Text -->
              <p>Athletic injury rehab and maintenance cares. Athletes are uniquely interested in the performance of their bodies, and as such are highly motivated when it comes to their musculoskeletal care.</p>
              <!-- End Text -->
              ...
              <!-- Text -->
              <p>Swedish massage, Joint mobilization & Myofascial techniques</p>
              <!-- End Text -->
              ...
              <!-- Text -->
              <p>I am always in the process of learning and developing my practice to meet my patient’s needs. Each new patient I take on is a journey of discovery and exploration, and I am committed to helping patient’s achieve their goals.</p>
              <!-- End Text -->
    ...
    <div class="u-bg-light-blue-50 u-space-2-bottom">
      <div class="container">
        ...
        <div class='embedsocial-reviews' data-ref="582d422eaa77c562cd607de62b21e90f45d172b4"></div><script>(function(d, s, id){var js; if (d.getElementById(id)) {return;} js = d.createElement(s); js.id = id; js.src = "https://embedsocial.com/embedscript/ri.js"; d.getElementsByTagName("head")[0].appendChild(js);}(document, "script", "EmbedSocialReviewsScript"));</script>
