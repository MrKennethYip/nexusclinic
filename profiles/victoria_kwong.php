...
<head>
  <!-- Title -->
  <title>Victoria Kwong | Physiotherapist | Nexus Massage & Rehab at Yonge & Eglinton</title>

  <meta name="Description" content="Learn about the staff at Nexus Massage & Rehab. Victoria Kwong specializes in physiotherapy, rehabilitation & more at our Yonge & Eglinton clinic. Learn more!">
  <meta name="keywords" content="Victoria, Kwong, Physiotherapy, rehabilitation, strength, fitness, disability, injuries, exercise, frozen shoulder, knee pain, shoulder pain. shin splints, training, carpal tunnel, tennis elbow, meniscus tear, rotator cuff, strain, sprain, exercises, rehab, physio, endurance, recover, recovery, strengthening, physiotherapist, the best physiotherapist, physio at yonge and eglinton, rehab exercises, physio at yonge and eglinton">
...
<body>
  ...
  <main id="content" role="main">
    ...
    <div class="position-relative text-center custom-top-spacing u-gradient-overlay-half-info-v1 u-bg-img-hero">
      <div class="row justify-content-md-center">
        ...
        <div class="col-md-8 col-lg-7 col-xl-5">
          ...
          <!-- Info -->
          <div class="mb-4">
            <h1 class="display-4 font-size-48--md-down text-white font-weight-bold">VICTORIA KWONG</h1>
          </div>

          <ul class="list-inline">
            <li class="list-inline-item">
              <a class="u-text-light" href="mailto:victoria@nexushealthclinic.com">
                <span class="far fa-envelope mr-2"></span>
                victoria@nexushealthclinic.com
              </a>
            </li>
          </ul>
          <!-- End Info -->
          ...
          <!-- Avatar -->
          <img class="img-fluid u-xl-avatar u-xl-avatar--bordered u-avatar-v1 rounded-circle mx-auto" src="https://s3.ca-central-1.amazonaws.com/nexusmassageclinic/images/profile/med/victoria_kwong.jpg" alt="Victoria Kwong - Physiotherapist">
          <!-- End Avatar -->
          </div>
        </div>
            ...
            <div class="card p-1 mb-4" style="min-width: 225px;">
              <div class="card-body text-center">
                <div class="mb-2">
                  ...
                  <a class="btn btn-block u-btn-primary--air transition-3d-hover" href="mailto:victoria@nexushealthclinic.com">
                    <span class="far fa-envelope mr-2"></span>
                    Send a Message
                  </a>
                </div>
            ...
            <div class="card p-1 mb-4" style="min-width: 225px;">
              <div class="card-body">
                ...
                <span class="d-flex align-items-start">
                  ...
                  <div class="ml-2">
                    <p class="text-dark"><strong>Mon:</strong><span class="ml-3"></span>10am - 9:00pm</p>
                    <p class="text-dark"><strong>Wed:</strong><span class="ml-3"></span>2:30pm - 9:00pm</p>
                    <p class="text-dark"><strong>Thurs:</strong><span class="ml-3"></span>10am - 9:00pm</p>
    ...
    <div class="u-bg-light-blue-50 u-space-2-bottom">
      <div class="container">
        <div class='embedsocial-reviews' data-ref="3ae85aecd90690d9e67b46426e0a028f143ebd59"></div><script>(function(d, s, id){var js; if (d.getElementById(id)) {return;} js = d.createElement(s); js.id = id; js.src = "https://embedsocial.com/embedscript/ri.js"; d.getElementsByTagName("head")[0].appendChild(js);}(document, "script", "EmbedSocialReviewsScript"));</script>
      </div>
    </div>
