...
<head>
  <!-- Title -->
  <title>Jie Lu (RMT) | Nexus Massage & Rehab | (647) 557-6267</title>

  <meta name="Description" content="Learn about the team at Nexus Massage & Rehab. Jie Lu specializes in massage therapy & lower back pain at our Yonge & Eglinton clinic. Learn more!">
  <meta name="keywords" content="Jie Lu, Best RMT, deep tissue, back pain, neck pain, massage at yonge and eglinton, best massage therapist, muscle aches, sore muscles, muscle spasm, proper posture, ergonomic assessment, strong massage therapist, deep pressure, professional massage therapist, massage for back pain, massage to decrease neck pain, massage to help back pain, best massage therapist, back problems, back relief, upper back pain, what helps with back pain, sore back, chronic neck pain, back pain relief, lower back pain relief, lumbar spine, back strain, neck problems, sore neck, backache, back strain, neck and shoulder tension">
  ...
  <main id="content" role="main">
    ...
    <div class="position-relative text-center custom-top-spacing u-gradient-overlay-half-info-v1 u-bg-img-hero">
      <div class="row justify-content-md-center">
        ...
        <div class="col-md-8 col-lg-7 col-xl-5">
          ...
          <!-- Info -->
          <div class="mb-4">
            <h1 class="display-4 font-size-48--md-down text-white font-weight-bold">JIE LU</h1>
          </div>

          <ul class="list-inline">
            <li class="list-inline-item">
              <a class="u-text-light" href="mailto:Jie@nexushealthclinic.com">
                <span class="far fa-envelope mr-2"></span>
                Jie@nexushealthclinic.com
              </a>
            </li>
          </ul>
          <!-- End Info -->
          ...
          <!-- Avatar -->
          <img class="img-fluid u-xl-avatar u-xl-avatar--bordered u-avatar-v1 rounded-circle mx-auto" src="https://nexusclinicassets.s3.ca-central-1.amazonaws.com/images/profile/med/jie_lu.jpg" alt="Jie Lu - Profile">
          <!-- End Avatar -->
          </div>
        </div>
      ...
      <div class="container u-space-2">
        <div class="row">
            ...
            <div class="card p-1 mb-4" style="min-width: 225px;">
              <div class="card-body text-center">
                <div class="mb-2">
                  ...
                  <a class="btn btn-block u-btn-primary--air transition-3d-hover" href="mailto:Jie@nexushealthclinic.com">
                    <span class="far fa-envelope mr-2"></span>
                    Send a Message
                  </a>
                </div>
            ...
            <div class="card p-1 mb-4" style="min-width: 225px;">
              <div class="card-body">
                ...
                <span class="d-flex align-items-start">
                  ...
                  <div class="ml-2">
                    <p class="text-dark"><strong>Mon:</strong><span class="ml-3"></span>8am - 9pm</p>
                    ...
                    <p class="text-dark"><strong>Thurs:</strong><span class="ml-3"></span>8am - 9pm</p>
          ...
          <div class="col-lg-9">
              ...
              <!-- Text -->
              <p>I’m a Registered Massage Therapist who blends Swedish and Chinese massage techniques to help clients relax both body and mind while easing muscle tension and pain. I truly love my work and feel deeply fulfilled each time a client tells me they feel better after a treatment.</p>
              <!-- End Text -->
              ...
              <!-- Text -->
              <p>I enjoy helping clients relieve tension and pain in the shoulders, neck, and lower back—areas that so often affect daily comfort and movement. These are the most common concerns I see, and it’s rewarding to help people feel lighter, more mobile, and free of discomfort through focused massage therapy.</p>
              <!-- End Text -->
              ...
              <!-- Text -->
              <p>I specialize in three key treatments designed to help you feel your best: relaxing massages to calm the mind and ease tension, trigger point therapy to release stubborn knots and relieve pain, and therapeutic stretching to improve flexibility, posture, and mobility. Each session is tailored to your unique needs, leaving you feeling balanced, refreshed, and restored.</p>
              <!-- End Text -->
              ...
              <!-- Text -->
              <p>I take great pride in being able to intuitively sense where my clients hold tension or discomfort and provide targeted, effective treatment that brings real relief. It’s deeply rewarding to know that my touch can help someone feel more at ease, relaxed, and balanced.</p>
              <!-- End Text -->
    ...
    <div class="u-bg-light-blue-50 u-space-2-bottom">
      <div class="container">
        ...
        <div class="embedsocial-reviews" data-ref="276f9a5d60cc16156d29e200c2f658821961dccd"></div> <script> (function(d, s, id){ var js; if (d.getElementById(id)) {return;} js = d.createElement(s); js.id = id; js.src = "https://embedsocial.com/embedscript/ri.js"; d.getElementsByTagName("head")[0].appendChild(js); }(document, "script", "EmbedSocialReviewsScript")); </script>
