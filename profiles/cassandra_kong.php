...
<head>
  <!-- Title -->
  <title>Cassandra Kong | Registered Massage Therapist | Nexus Massage</title>

  <meta name="Description" content="Learn about the fully licensed staff at Nexus Massage & Rehab. Our clinic's co-founder Cassandra Kong offers RMT at Yonge & Eglington. Read more today!">
  <meta name="keywords" content="Cassandra Kong, Cassie, Cass Kong, Best RMT, deep tissue, back pain, neck pain, massage at yonge and eglinton, best massage therapist, muscle aches, sore muscles, muscle spasm, proper posture, ergonomic assessment, strong massage therapist, deep pressure, professional massage therapist, massage for back pain, massage to decrease neck pain, massage to help back pain, best massage therapist, back problems, back relief, upper back pain, what helps with back pain, sore back, chronic neck pain, back pain relief, lower back pain relief, lumbar spine, back strain, neck problems, sore neck, backache, back strain, neck and shoulder tension">
    ...
    <div class="position-relative text-center custom-top-spacing u-gradient-overlay-half-info-v1 u-bg-img-hero">
      <div class="row justify-content-md-center">
        ...
        <div class="col-md-8 col-lg-7 col-xl-5">
          ...
          <!-- Info -->
          <div class="mb-4">
            <h1 class="display-4 font-size-48--md-down text-white font-weight-bold">CASSANDRA KONG</h1>
          </div>

          <ul class="list-inline">
            <li class="list-inline-item">
              <a class="u-text-light" href="mailto:cass@nexushealthclinic.com">
                <span class="far fa-envelope mr-2"></span>
                cass@nexushealthclinic.com
              </a>
            </li>
          </ul>
          <!-- End Info -->
          ...
          <!-- Avatar -->
          <img class="img-fluid u-xl-avatar u-xl-avatar--bordered u-avatar-v1 rounded-circle mx-auto" src="https://s3.ca-central-1.amazonaws.com/nexusmassageclinic/images/profile/med/cassandra_kong.jpg" alt="Cassandra Kong - Registered Massage Therapist">
          <!-- End Avatar -->
          </div>
        </div>
      ...
      <div class="container u-space-2">
        <div class="row">
            ...
            <div class="card p-1 mb-4" style="min-width: 225px;">
              <div class="card-body text-center">
                <div class="mb-2">
                  ...
                  <a class="btn btn-block u-btn-primary--air transition-3d-hover" href="mailto:cass@nexushealthclinic.com">
                    <span class="far fa-envelope mr-2"></span>
                    Send a Message
                  </a>
                </div>
            ...
            <div class="card p-1 mb-4" style="min-width: 225px;">
              <div class="card-body">
                ...
                <span class="d-flex align-items-start">
                  ...
                  <div class="ml-2">
                    <p class="text-dark"><strong>Wed - Thurs:</strong><span class="ml-3"></span>10am - 8pm</p>
                    <p class="text-dark"><strong>Mon:</strong><span class="ml-3"></span>5:30pm - 9pm</p>
                    <p class="text-dark"><strong>Wed:</strong><span class="ml-3"></span>5:30pm - 9pm</p>
                    <p class="text-dark"><strong>Sun:</strong><span class="ml-3"></span>10am - 3:30pm</p>
                  </div>
                </span>
                <!-- End User -->
          ...
          <div class="col-lg-9">
              ...
              <!-- Text -->
              <p>I specialize in Myofascial Release, Trigger Point Therapy, and Deep Tissue Massage.</p>
              <p>The myofascial release helps with loosening the connective tissue underlying the skin, muscles, and organs, making the muscle easier to work with and decrease pain. Trigger point therapy helps with decreasing pain and increasing mobility of the muscle. The benefit of deep tissue massage helps release muscle tension and stiffness.</p>
              <!-- End Text -->
