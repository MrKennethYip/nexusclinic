    ...
    <div class="position-relative text-center custom-top-spacing u-gradient-overlay-half-info-v1 u-bg-img-hero">
      <div class="row justify-content-md-center">
        ...
        <div class="col-md-8 col-lg-7 col-xl-5">
          ...
          <!-- Avatar -->
          <img class="img-fluid u-xl-avatar u-xl-avatar--bordered u-avatar-v1 rounded-circle mx-auto" src="https://nexusclinicassets.s3.ca-central-1.amazonaws.com/images/profile/med/kyle_ngo.jpg" alt="Kyle Ngo - Registered Massage Therapist">
          <!-- End Avatar -->
          </div>
        </div>
              ...
              <div class="card-body">
                ...
                <span class="d-flex align-items-start">
                  ...
                  <div class="ml-2">
                    ...
                    <p class="text-dark"><strong>Thur:</strong><span class="ml-3"></span>1pm - 8pm</p>
