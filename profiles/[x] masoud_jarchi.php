...
<head>
  <!-- Title -->
  <title>Masoud Jarchi | Osteopath | Nexus Massage</title>

  <meta name="Description" content="Meet our team! Masoud Jarchi is an Osteopath at our Yonge & Eglinton clinic.">
  <meta name="keywords" content="Masoud Jarchi, Masoud, Jarchi, Osteopath, Osteopathic, Osteopathy">
...
<body>
  ...
  <main id="content" role="main">
    ...
    <div class="position-relative text-center custom-top-spacing u-gradient-overlay-half-info-v1 u-bg-img-hero">
      <div class="row justify-content-md-center">
        ...
        <div class="col-md-8 col-lg-7 col-xl-5">
          ...
          <!-- Info -->
          <div class="mb-4">
            <h1 class="display-4 font-size-48--md-down text-white font-weight-bold">MASOUD JARCHI</h1>
          </div>

          <ul class="list-inline">
            <li class="list-inline-item">
              <a class="u-text-light" href="mailto:masoud@nexushealthclinic.com">
                <span class="far fa-envelope mr-2"></span>
                masoud@nexushealthclinic.com
              </a>
            </li>
          </ul>
          <!-- End Info -->
          ...
          <!-- Avatar -->
          <img class="img-fluid u-xl-avatar u-xl-avatar--bordered u-avatar-v1 rounded-circle mx-auto" src="https://nexusclinicassets.s3.ca-central-1.amazonaws.com/images/profile/med/masoud_jarchi.jpg" alt="Masoud Jarchi - Osteopath">
          <!-- End Avatar -->
          </div>
        </div>
      ...
      <div class="container u-space-2">
        <div class="row">
            ...
            <div class="card p-1 mb-4" style="min-width: 225px;">
              <div class="card-body text-center">
                <div class="mb-2">
                  ...
                  <a class="btn btn-block u-btn-primary--air transition-3d-hover" href="mailto:masoud@nexushealthclinic.com">
                    <span class="far fa-envelope mr-2"></span>
                    Send a Message
                  </a>
                </div>
          ...
          <div class="col-lg-9">
              ...
              <!-- Text -->
              <p>I have been in rehabilitation field more than 15 years, 10 years in occupational therapy, and since 2018 I am practicing Manual Osteopathy.</p>
              <!-- End Text -->
              ...
              <!-- Text -->
              <p>I love my field no matter which case I have. But as back pain, upper back, neck and shoulder, hip and knee pain are very common in Canada, most of the clients I have had belonged to these. So I have more experience in those patients.</p>
              <!-- End Text -->
              ...
              <!-- Text -->
              <p>Joint mobilization, Deep tissue massage, Energy Muscle Testing</p>
              <!-- End Text -->
              ...
              <!-- Text -->
              <p>I practice 100% client focused. Based on my experience patients could get expected results in very reasonable time.</p>
              <!-- End Text -->
    ...
    <div class="u-bg-light-blue-50 u-space-2-bottom">
      <div class="container">
        <!-- Review Widget -->
        <div class='embedsocial-reviews' data-ref="23a87a3fe8716a67de768eb4bbe43c436e70aa34"></div>
