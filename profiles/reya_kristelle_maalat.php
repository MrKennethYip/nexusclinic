    ...
    <div class="position-relative text-center custom-top-spacing u-gradient-overlay-half-info-v1 u-bg-img-hero">
      <div class="row justify-content-md-center">
        ...
        <div class="col-md-8 col-lg-7 col-xl-5">
          ...
          <!-- Info -->
          <div class="mb-4">
            <h1 class="display-4 font-size-48--md-down text-white font-weight-bold">REYA KRISTELLE MAALAT</h1>
          </div>

          <ul class="list-inline">
            <li class="list-inline-item">
              <a class="u-text-light" href="mailto:reya@nexushealthclinic.com">
                <span class="far fa-envelope mr-2"></span>
                reya@nexushealthclinic.com
              </a>
            </li>
          </ul>
          <!-- End Info -->
        ...
        <div class="row">
            ...
            <div class="card p-1 mb-4" style="min-width: 225px;">
              <div class="card-body text-center">
                <div class="mb-2">
                  ...
                  <a class="btn btn-block u-btn-primary--air transition-3d-hover" href="mailto:reya@nexushealthclinic.com">
                    <span class="far fa-envelope mr-2"></span>
                    Send a Message
                  </a>
                </div>
              ...
              <div class="card-body">
                ...
                <span class="d-flex align-items-start">
                  ...
                  <div class="ml-2">
                    ...
                    <p class="text-dark"><strong>Weds:</strong><span class="ml-3"></span>12pm - 9pm</p>
                    <p class="text-dark"><strong>Fri:</strong><span class="ml-3"></span>12pm - 9pm</p>
                  </div>
                </span>
                <!-- End User -->
          ...
          <div class="col-lg-9">
            ...
            <div class="mb-3">
              ...
              <!-- Text -->
              <p>I am a Registered Resident Physiotherapist with international experience in both inpatient and outpatient settings. I began my career as a Physical Therapist in the Philippines, where I worked in a hospital environment providing care from acute treatment to outpatient rehabilitation. This diverse clinical exposure strengthened my ability to design and implement personalized treatment plans that address each patient’s unique goals and functional needs.</p>
              <p>I moved to Canada in 2018 and have since had the opportunity to further develop my knowledge and clinical skills. Gaining experience within the Canadian healthcare system has helped me understand its practices, cultural expectations, and patient-centered approach to care.</p>
              <!-- End Text -->
              ...
              <!-- Text -->
              <p>I enjoy working with a wide variety of cases—whether musculoskeletal, neurological, or cardiopulmonary in nature. My approach always begins with actively listening to the patient to understand their goals and individual challenges. From there, I design treatments that are not only evidence-based but also personally meaningful to each patient.</p>
              <p>I have a particular passion for working with geriatric patients. I find it deeply rewarding to help older adults maintain their independence, improve their mobility, and enhance their overall quality of life. Building strong therapeutic relationships and empowering patients to take an active role in their recovery is at the heart of my practice.</p>
              <!-- End Text -->
              ...
              <!-- Text -->
              <p>In my practice, I specialize in manual therapy, laser therapy, and therapeutic exercise prescription. My manual therapy skills allow me to address soft tissue and joint dysfunctions effectively, helping to reduce pain and improve mobility. I incorporate laser therapy as a non-invasive modality to support tissue healing and reduce inflammation. My approach to exercise prescription is individualized and goal-oriented, designed to restore strength, flexibility, balance, and functional movement patterns. These techniques, combined with a compassionate and collaborative approach, help me deliver comprehensive care that supports long-term recovery and wellness.</p>
              <!-- End Text -->
              ...
              <!-- Text -->
              <p>I take pride in contributing to both patient outcomes and the professional growth of the team. I actively share my knowledge with patients and colleagues, and I value collaboration with other healthcare providers to ensure coordinated and effective care. Working together as a team allows us to achieve the best possible results for those we serve.</p>
              <!-- End Text -->
              ...
              <!-- Text -->
              <p>I take the time to understand each patient’s unique needs and deliver focused, individualized care. My goal is to help you heal efficiently—without ever compromising the quality you deserve.</p>
              <!-- End Text -->
