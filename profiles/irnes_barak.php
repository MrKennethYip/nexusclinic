            ...
            <div class="card p-1 mb-4" style="min-width: 225px;">
              <div class="card-body">
                ...
                <span class="d-flex align-items-start">
                  ...
                  <div class="ml-2">
                    <p class="text-dark"><strong>Mon:</strong><span class="ml-3"></span>2pm - 7pm</p>
                    <p class="text-dark"><strong>Fri:</strong><span class="ml-3"></span>10am - 3pm</p>
                    <p class="text-dark"><strong>Sun:</strong><span class="ml-3"></span>2:30pm - 7pm</p>
