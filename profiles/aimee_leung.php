...
<head>
  <!-- Title -->
  <title>Aimee Leung | Registered Acupuncturist | Nexus Massage & Rehab </title>

  <meta name="Description" content="Learn about the staff at Nexus Massage & Rehab. Aimee Leung specializes in acupuncture & holistic care at our Yonge & Eglinton clinic. Learn more!">
  <meta name="keywords" content="Aimee Leung, TCM, traditional chinese medicine, cupping, chi, wellness, healthy, trigger points, acupressure, acupuncture points, guasha, nutrition. Diet, weight loss, depression, anxiety, sleep, menstruation, pain, digestion, fertility, stress, meridian points, tongue diagnosis, pulse diagnosis, tuina, chinese massage, the best acupuncturist at yonge and eglinton, acupuncturist at yonge and eglinton">
...
<body>
  ...
  <main id="content" role="main">
    ...
    <div class="position-relative text-center custom-top-spacing u-gradient-overlay-half-info-v1 u-bg-img-hero">
      <div class="row justify-content-md-center">
        ...
        <div class="col-md-8 col-lg-7 col-xl-5">
          ...
          <!-- Info -->
          <div class="mb-4">
            <h1 class="display-4 font-size-48--md-down text-white font-weight-bold">AIMEE LEUNG</h1>
          </div>

          <ul class="list-inline">
            <li class="list-inline-item">
              <a class="u-text-light" href="mailto:Aimee@nexushealthclinic.com">
                <span class="far fa-envelope mr-2"></span>
                Aimee@nexushealthclinic.com
              </a>
            </li>
          </ul>
          <!-- End Info -->
      ...
      <div class="container u-space-2">
        <div class="row">
          <div class="col-lg-3 mb-7 mb-lg-0">
            ...
            <div class="card p-1 mb-4" style="min-width: 225px;">
              <div class="card-body text-center">
                <div class="mb-2">
                  ...
                  <a class="btn btn-block u-btn-primary--air transition-3d-hover" href="mailto:Aimee@nexushealthclinic.com">
                    <span class="far fa-envelope mr-2"></span>
                    Send a Message
                  </a>
                </div>
            ...
            <div class="card p-1 mb-4" style="min-width: 225px;">
              <div class="card-body">
                ...
                <!-- User -->
                  <div class="card-header border-0 py-3 d-flex align-items-center">
                    <img src="https://s3.ca-central-1.amazonaws.com/nexusmassageclinic/icons/tuina-massage-icon.jpg" class="rounded-circle u-avatar align-self-start mr-3">
                    <div>
          ...
          <div class="col-lg-9">
              ...
              <!-- Text -->
              <p>Traditional Chinese Medicine, Auricular (Ear) and Cosmetic Acupuncture, Tuina and Shiatsu Massage, and Cupping.</p>
              <!-- End Text -->
              ...
              <!-- Text -->
              <p>Being part of the process in my patients' recovery and personal transformation to healthier, stronger and more balanced versions of themselves.</p>
              <!-- End Text -->
              ...
              <!-- Text -->
              <p>I provide a safe and open space to support patients on a physical, mental and emotional level. I take time to understand my patients' health condition and concerns and to explain treatment. I empower patients with knowledge, tools and intuitive insights into their health and wellbeing.</p>
              <!-- End Text -->
    ...
    <div class="u-bg-light-blue-50 u-space-2-bottom">
      <div class="container">
        <!-- Review Widget -->
        <div class="embedsocial-reviews" data-ref="49a3427637563f293e9ba28677afb94c40fe5608"></div> <script> (function(d, s, id){ var js; if (d.getElementById(id)) {return;} js = d.createElement(s); js.id = id; js.src = "https://embedsocial.com/embedscript/ri.js"; d.getElementsByTagName("head")[0].appendChild(js); }(document, "script", "EmbedSocialReviewsScript")); </script>
        <!-- End Review Widget -->
      </div>
    </div>
