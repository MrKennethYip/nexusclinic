...
<head>
  <!-- Title -->
  <title>Ben Chai (RMT) | Nexus Massage & Rehab | (647) 557-6267</title>

  <meta name="Description" content="Learn about the team at Nexus Massage & Rehab. Ben Chai specializes in massage therapy & lower back pain at our Yonge & Eglinton clinic. Learn more!">
  <meta name="keywords" content="Ben Chai, Best RMT, deep tissue, back pain, neck pain, massage at yonge and eglinton, best massage therapist, muscle aches, sore muscles, muscle spasm, proper posture, ergonomic assessment, strong massage therapist, deep pressure, professional massage therapist, massage for back pain, massage to decrease neck pain, massage to help back pain, best massage therapist, back problems, back relief, upper back pain, what helps with back pain, sore back, chronic neck pain, back pain relief, lower back pain relief, lumbar spine, back strain, neck problems, sore neck, backache, back strain, neck and shoulder tension">
  ...
  <main id="content" role="main">
    ...
    <div class="position-relative text-center custom-top-spacing u-gradient-overlay-half-info-v1 u-bg-img-hero">
      <div class="row justify-content-md-center">
        ...
        <div class="col-md-8 col-lg-7 col-xl-5">
          ...
          <!-- Info -->
          <div class="mb-4">
            <h1 class="display-4 font-size-48--md-down text-white font-weight-bold">BEN CHAI</h1>
          </div>

          <ul class="list-inline">
            <li class="list-inline-item">
              <a class="u-text-light" href="mailto:ben@nexushealthclinic.com">
                <span class="far fa-envelope mr-2"></span>
                ben@nexushealthclinic.com
              </a>
            </li>
          </ul>
          <!-- End Info -->
          ...
          <!-- Avatar -->
          <img class="img-fluid u-xl-avatar u-xl-avatar--bordered u-avatar-v1 rounded-circle mx-auto" src="https://s3.ca-central-1.amazonaws.com/nexusmassageclinic/images/profile/med/ben_chai.jpg" alt="Ben Chai - Profile">
          <!-- End Avatar -->
          </div>
        </div>
      ...
      <div class="container u-space-2">
        <div class="row">
            ...
            <div class="card p-1 mb-4" style="min-width: 225px;">
              <div class="card-body text-center">
                <div class="mb-2">
                  ...
                  <a class="btn btn-block u-btn-primary--air transition-3d-hover" href="mailto:ben@nexushealthclinic.com">
                    <span class="far fa-envelope mr-2"></span>
                    Send a Message
                  </a>
                </div>
              ...
              <div class="card-body">
                ...
                <span class="d-flex align-items-start">
                  ...
                  <div class="ml-2">
                    ...
                    <p class="text-dark"><strong>Tues:</strong><span class="ml-3"></span>8pm - 1:30pm</p>
                  </div>
                </span>
                <!-- End User -->
          ...
          <div class="col-lg-9">
              ...
              <!-- Text -->
              <p>With 20 years of experience in the massage therapy field, I am dedicated to providing personalized, high-quality care to each of my clients. Over the years, I have developed a wide range of skills, including deep tissue and sports massage, Shiatsu, manual lymphatic drainage, and trigger point therapy.</p>
              <p>I take pride in tailoring each treatment to meet your unique needs, and I’m passionate about helping you achieve better health and well-being through my work.</p>
              <!-- End Text -->
              ...
              <!-- Text -->
              <p>I have extensive experience in trigger point therapy, especially for areas like the upper traps, calves, hamstrings, headaches, and sciatica. These are cases I truly enjoy working on because they align with my expertise.</p>
              <!-- End Text -->
              ...
              <!-- Text -->
              <p>My top three areas of expertise are trigger point therapy, treating sciatica, and addressing frozen shoulder conditions.</p>
              <!-- End Text -->
              ...
              <!-- Text -->
              <p>I take great pride in helping my clients achieve their health goals, ensuring they leave not only satisfied but also empowered to maintain their well-being.</p>
              <!-- End Text -->
              ...
              <!-- Text -->
              <p>I maintain a high level of professionalism in my work, consistently striving to deliver effective results with every treatment I provide.</p>
              <!-- End Text -->
    ...
    <div class="u-bg-light-blue-50 u-space-2-bottom">
      <div class="container">
        ...
        <div class="embedsocial-reviews" data-ref="48288d7b778b9046f11d6a659e1dc9fbff85ac93"></div> <script> (function(d, s, id){ var js; if (d.getElementById(id)) {return;} js = d.createElement(s); js.id = id; js.src = "https://embedsocial.com/embedscript/ri.js"; d.getElementsByTagName("head")[0].appendChild(js); }(document, "script", "EmbedSocialReviewsScript")); </script>
