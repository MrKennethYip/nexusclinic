    ...
    <div class="container u-space-2">
      ...
      <div class="u-cubeportfolio">
        ...
        <div class="cbp"
          ...
          <!-- Item -->
          <div class="cbp-item rmt chiro acupuncture physio osteopath">
            <img class="rounded p-2 responsively-lazy" style="border: #898A8D 2px solid;" src="https://s3.ca-central-1.amazonaws.com/nexusmassageclinic/images/profile/med/gursimran_kandra.jpg" data-srcset="https://s3.ca-central-1.amazonaws.com/nexusmassageclinic/images/profile/med/gursimran_kandra.jpg 500w, https://s3.ca-central-1.amazonaws.com/nexusmassageclinic/images/profile/med/gursimran_kandra.jpg 1000w, https://s3.ca-central-1.amazonaws.com/nexusmassageclinic/images/profile/lrg/gursimran_kandra.jpg 1500w" sizes="(min-width: 993px) 1500px,(min-width: 768px) and (max-width: 992px) 1000px, (max-width: 767px) 500px"  alt="Gursimran Kandra - Nexus Massage and Rehab - Toronto">
            <div class="py-3 blurb">
              <h4 class="h6 text-dark mb-0">Gursimran Kandra</h4>
              <p class="small mb-0">
                Clinic Administrator<br><br>
              </p>
            </div>
