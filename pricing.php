                    ...
                    <div class="media-body p-1">
                      ...
                      <div class="u-space-1-top">
                        <ul class="list-unstyled">
                          ...
                          <li class="u-pricing-v2__list-item py-1">&nbsp</li>
                          <li class="small text-muted py-1"><strong>**Osteopathy does not qualify for direct billing. Please refer to your insurance provider for coverage. Please note that we are unable to accept insurance coverage from <u>Great West Life</u> and <u>Group Health</u> at this time.**</strong></li>
                        </ul>
                      </div>
                      <!-- End Content --> 
                    </div>
